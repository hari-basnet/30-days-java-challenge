...
public class MadLibs {
	...
	public void printInstructions(){
		System.out.println("Welcome to the MadLibs game. If you type in words, we'll give you a story. Start by typing in your name.");
	}
	...
	public void putTogetherTheStory(){
		...
		if(num == 0) {
			story = "Jesse and her best friend " + getName() + " went to Disney World today! "
				...
				+ getAdjective2() + " fireworks shooting form the " + getNoun3() + ".";
		} else {
	...
	public void printOddAndEvenLettersInAString() {
